import { CacheDecoratorOptions } from "./interfaces/cache-decorator-options.ts";
import { Storage, InMemoryCache } from '../package.ts';
import { StorageProvider } from '../provider/storage-provider.ts'
import { liberty } from "../mod.ts";
import { CacheService } from "../cache-service.ts";

export function Cache(_options: CacheDecoratorOptions = { type: undefined as unknown as Storage, ttl: 0 }): MethodDecorator {
